...
public class EventController {
    ...
    public ResponseEntity<?> post(@RequestBody Event event,UriComponentsBuilder ucBuilder) {
        ...
        headers.setLocation(ucBuilder.path("/get/{eventid}").buildAndExpand(event.getId()).toUri());
    ...
    public @ResponseBody ResponseEntity<?> getById(@PathVariable Long eventId,UriComponentsBuilder ucBuilder) {
